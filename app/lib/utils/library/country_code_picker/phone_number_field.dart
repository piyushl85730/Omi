...
// import 'package:intl_phone_field/country_picker_dialog.dart'hide PickerDialogStyle,CountryPickerDialog;
...
class IntlPhoneField extends StatefulWidget {
  ...
  /// {@macro flutter.core.editableText.readOnly}
  final bool readOnly;
  final FormFieldSetter<PhoneNumber>? onSaved;

  /// {@macro flutter.core.editableText.onChanged}
  ///
  /// See also:
  ///
  ...
  /// {@macro flutter.core.editableText.keyboardType}
  ...
  /// {@macro flutter.core.editableText.onSubmitted}
  ///
  /// See also:
  ///
  ...
  /// {@macro flutter.core.editableText.inputFormatters}
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(7), color: Colors.white24),
          child: InkWell(
            borderRadius:
